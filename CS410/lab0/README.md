## **Lab 0 Reflection: Introduction to Soldering**

This lab provided an excellent gateway into the world of soldering. Due to time constraints and professional commitments at **Intel**, I transitioned my workspace from the lab to my home garage to complete the project. Over the course of the assignment, I refined my technique—specifically finding that a "side-to-side" motion with the solder wire helped consistently achieve the ideal **"Hershey’s Kiss"** fillet.
